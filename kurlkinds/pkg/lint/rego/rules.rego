# this file contains a set of auxiliary functions used when evaluating a kurl installer struct,
# errors are defined using these functions/evaluations in errors.rego.
