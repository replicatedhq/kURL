...
// Add creates a new Installer Controller and adds it to the Manager with default RBAC. The Manager will set fields on the Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to Installer
	err = c.Watch(&source.Kind{Type: &clusterv1beta1.Installer{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by Installer - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &clusterv1beta1.Installer{},
	})
	if err != nil {
		return err
	}
