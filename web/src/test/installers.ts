...
`;
        const out = Installer.parse(goodRKE2).validate();
...
spec:
  ...
  rke2:
    version: "v1.19.7+rke2r1"
`;
        const badK8sOut = Installer.parse(bad).validate();
