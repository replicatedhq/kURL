...
export const kubernetesConfigSchema = {
  ...
  properties: {
    ...
    loadBalancerUseFirstPrimary: { type: "boolean", flag: "kubernetes-load-balancer-use-first-primary" , description: "DEPRECATED: Use first primary address as control plane endpoint in HA cluster", deprecated: true, hidden: true },
