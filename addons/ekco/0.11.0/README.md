...
- `enable-internal-load-balancer`: Run haproxy on all nodes forwarding to all API server pods
- `internal-load-balancer-port`: The port for the internal load balancer to liste on.
