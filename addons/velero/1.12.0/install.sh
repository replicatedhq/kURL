...
function velero_install() {
    ...
    "$src"/assets/velero-v"${VELERO_VERSION}"-linux-amd64/velero install \
        ...
        --plugins velero/velero-plugin-for-aws:v1.8.0,velero/velero-plugin-for-gcp:v1.8.0,velero/velero-plugin-for-microsoft-azure:v1.8.0,replicated/local-volume-provider:v0.5.4,"$KURL_UTIL_IMAGE" \
