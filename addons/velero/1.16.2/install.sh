...
function velero_install() {
    ...
    "$src"/assets/velero-v"${VELERO_VERSION}"-linux-amd64/velero install \
        ...
        --plugins velero/velero-plugin-for-aws:v1.12.2,velero/velero-plugin-for-gcp:v1.12.2,velero/velero-plugin-for-microsoft-azure:v1.12.2,replicated/local-volume-provider:v0.6.10,"$KURL_UTIL_IMAGE" \
