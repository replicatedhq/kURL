...
function velero_install() {
    ...
    "$src"/assets/velero-v"${VELERO_VERSION}"-linux-amd64/velero install \
        ...
        --plugins velero/velero-plugin-for-aws:v1.11.0,velero/velero-plugin-for-gcp:v1.11.0,velero/velero-plugin-for-microsoft-azure:v1.11.0,replicated/local-volume-provider:v0.6.8,"$KURL_UTIL_IMAGE" \
