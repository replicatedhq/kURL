...
function minio() {
    ...
    if [ -n "$minio_ha_exists" ]; then
        ...
        kubectl set image -n minio statefulset/ha-minio minio=kotsadm/minio:RELEASE.2025-10-15T17-29-55Z
        ...
        kubectl set image -n minio deployment/minio minio=kotsadm/minio:RELEASE.2025-10-15T17-29-55Z 2>/dev/null || true
    else
