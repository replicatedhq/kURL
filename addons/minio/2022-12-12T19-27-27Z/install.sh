...
function minio() {
    local src="$DIR/addons/minio/2022-12-12T19-27-27Z"
    ...
    if [ -n "$minio_ha_exists" ]; then
        ...
        kubectl set image -n minio statefulset/ha-minio minio=minio/minio:RELEASE.2022-12-12T19-27-27Z
        ...
        kubectl set image -n minio deployment/minio minio=minio/minio:RELEASE.2022-12-12T19-27-27Z 2>/dev/null || true
    else
...
function minio_create_fs_migration_deployment() {
    local src="$DIR/addons/minio/2022-12-12T19-27-27Z/migrate-fs"
