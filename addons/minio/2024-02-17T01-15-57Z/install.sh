...
function minio() {
    local src="$DIR/addons/minio/2024-02-17T01-15-57Z"
    ...
    if [ -n "$minio_ha_exists" ]; then
        ...
        kubectl set image -n minio statefulset/ha-minio minio=minio/minio:RELEASE.2024-02-17T01-15-57Z
        ...
        kubectl set image -n minio deployment/minio minio=minio/minio:RELEASE.2024-02-17T01-15-57Z 2>/dev/null || true
    else
...
function minio_create_fs_migration_deployment() {
    local src="$DIR/addons/minio/2024-02-17T01-15-57Z/migrate-fs"
