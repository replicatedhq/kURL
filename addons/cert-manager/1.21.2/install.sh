# resources downloaded from https://github.com/cert-manager/cert-manager/releases/download/v1.21.2/cert-manager.yaml

cert-manager() {
  local src="$DIR/addons/cert-manager/1.21.2"
