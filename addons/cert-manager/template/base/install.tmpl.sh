# resources downloaded from https://github.com/cert-manager/cert-manager/releases/download/v__CERT_MANAGER_VERSION__/cert-manager.yaml

cert-manager() {
  local src="$DIR/addons/cert-manager/__CERT_MANAGER_VERSION__"
