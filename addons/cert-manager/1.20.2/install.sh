# resources downloaded from https://github.com/cert-manager/cert-manager/releases/download/v1.20.2/cert-manager.yaml

cert-manager() {
  local src="$DIR/addons/cert-manager/1.20.2"
