...
require (
	...
	github.com/kube-object-storage/lib-bucket-provisioner v0.0.0-20260915162514-8d4effaa2198 // indirect
...
// Exclude k8s.io/kube-openapi versions that require Go 1.27+
exclude k8s.io/kube-openapi v0.0.0-20260904170622-9ab3195f2a72

exclude k8s.io/kube-openapi v0.0.0-20260911184034-7970a1e230da
