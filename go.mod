...
require (
	...
	github.com/longhorn/go-common-libs v0.0.0-20240305104227-2dc630b0df92 // indirect
	github.com/longhorn/go-iscsi-helper v0.0.0-20240220070055-d137da5111d9 // indirect
