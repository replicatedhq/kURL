...
function bailIfUnsupportedOS() {
    case "$LSB_DIST$DIST_VERSION" in
        ubuntu16.04)
            ...
            ;;
        rhel7.4|rhel7.5|rhel7.6|rhel7.7|rhel7.8|rhel7.9|centos7.4|centos7.5|centos7.6|centos7.7|centos7.8|centos7.9|ol7.4|ol7.5|ol7.6|ol7.7|ol7.8|ol7.9)
            logWarn "Install is not supported on EOL RHEL/CentOS. Installation of Kubernetes will be best effort."
            ;;
        # BEGIN GENERATED os-matrix: bail-supported-ubuntu — edit os-matrix.yaml, run 'make generate-os-matrix'
        ubuntu18.04|ubuntu20.04|ubuntu22.04|ubuntu24.04|ubuntu26.04)
        # END GENERATED os-matrix: bail-supported-ubuntu
            ;;
        rhel8.0|rhel8.1|rhel8.2|rhel8.3|rhel8.4|rhel8.5|rhel8.6|rhel8.7|rhel8.8|rhel8.9|rhel8.10|rhel9.0|rhel9.1|rhel9.2|rhel9.3|rhel9.4|rhel9.5|rhel9.6|rhel9.7|rhel9.8|rhel9|rhel10.0|rhel10.1|rhel10.2|rhel10)
            ;;
