...
const list = ['build/install.sh', 'build/join.sh', 'build/upgrade.sh', 'build/tasks.sh', 'build/kustomize', 'build/addons', 'build/krew', 'build/kurlkinds', 'build/helm', 'build/bin'];
